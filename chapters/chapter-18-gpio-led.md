...
> 🖼️ 想看图？搜索「推挽输出 Push-Pull 电路图」，或问 AI「画一张推挽输出的电路示意图」。两个开关上下排列，上方 PMOS 接 VCC，下方 NMOS 接 GND，输出引脚从中间引出。
...
> 🖼️ 搜「开漏输出 Open-Drain 电路图」，或让 AI 画一张：只有下方的 NMOS 开关，上方引脚通过外部上拉电阻接到 VCC。
...
> 自行搜索「上拉电阻 下拉电阻 Pull-Up Pull-Down 电路」或让 AI 画对比图：上拉电阻接 VCC（默认高电平），下拉电阻接 GND（默认低电平），中间接按键到 GPIO。
